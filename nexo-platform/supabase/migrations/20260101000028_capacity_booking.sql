-- =============================================================
-- Migration 000028: Capacity / Group Bookings
-- =============================================================
-- 1. bookings.participant_count column
-- 2. RPC v6: get_available_slots with capacity check
-- =============================================================

-- 1. participant_count on bookings
ALTER TABLE bookings ADD COLUMN participant_count INT NOT NULL DEFAULT 1
  CHECK (participant_count >= 1 AND participant_count <= 50);

-- 2. RPC v6: capacity-aware get_available_slots
...
BEGIN
  ...
  -- Get max_participants for the service (default 1)
